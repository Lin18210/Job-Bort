            ...
            <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
                ...
                <div className='create-job-flex'>
                    <div className='lg-w-1/2 w-full'>
                        ...
                        <input type="text" placeholder="First name" defaultValue={"Web Developer"} {...register("jobTitle")} className='create-job-input' />
                    </div>
                    <div className='lg-w-1/2 w-full'>
                ...
                <div className='create-job-flex'>
                    <div className='lg-w-1/2 w-full'>
                        ...
                        <input type="date" placeholder="Ex: 2023-11-04" {...register("postingDate")} className='create-job-input' />
                    </div>
                    <div className='lg-w-1/2 w-full'>
                ...
                <div className='w-full'>
                    ...
                    defaultValue={"Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aliquid nostrum ducimus cupiditate ea voluptatem atque possimus consequuntur quis. Incidunt quaerat accusamus sapiente dignissimos iure esse cumque id reprehenderit est deserunt?"}
                    ></textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="email" placeholder="yourEmail@gmail.com" {...register("postedBy")} className='create-job-input' />
                </div>
